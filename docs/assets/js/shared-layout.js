          ...
          <div class="b-mega-panel__inner">
            ...
            <div class="b-mega-col">
              ...
              <div class="b-mega-item">
                ...
                <div class="b-mega-item__links">
                  <a href="https://EdgeInteract.BizFirstAi.com" class="b-mega-item__link" target="_blank" rel="noopener">Visit Site</a>
                  <a href="https://community.bizfirstai.com" class="b-mega-item__link" target="_blank" rel="noopener">Community</a>
                </div>
              </div>
            </div>
            ...
            <div class="b-mega-col">
              ...
              <div class="b-mega-item">
                ...
                <span class="b-mega-item__desc">Sovereign AI identity, on-chain governance &amp; verifiable credentials</span>
                <div class="b-mega-item__links">
        ...
        <div class="b-mobile-cat">
          ...
          <div class="b-mobile-cat__items">
            ...
            <div class="b-mobile-cat__item">
              ...
              <div class="b-mobile-cat__item-links">
                <a href="https://EdgeInteract.BizFirstAi.com" class="b-mobile-cat__item-link" target="_blank" rel="noopener">Visit Site</a>
                <a href="https://community.bizfirstai.com" class="b-mobile-cat__item-link" target="_blank" rel="noopener">Community</a>
              </div>
            </div>
          </div>
...
<div class="b-footer-container">
  ...
  <div class="b-footer-section">
    <h4>Products</h4>
    <ul>
      <li><a href="https://atlasforms.bizFirstAi.com" target="_blank" rel="noopener">Atlas Forms</a></li>
      <li><a href="https://flow.bizFirstAi.com" target="_blank" rel="noopener">Flow</a></li>
      <li><a href="https://octopus.bizFirstAi.com" target="_blank" rel="noopener">Octopus</a></li>
      <li><a href="https://passport.bizFirstAi.com" target="_blank" rel="noopener">Passport</a></li>
      <li><a href="https://dataocean.bizFirstAi.com" target="_blank" rel="noopener">Data Ocean</a></li>
  ...
  <div class="b-footer-section">
    ...
    <ul>
      ...
      <li><a href="https://community.bizfirstai.com" target="_blank" rel="noopener">Changelog</a></li>
    </ul>
  </div>
...
/**
 * Inject cookie consent CSS + JS once, referenced relative to this script's location.
 */
function _ensureCookieConsent() {
  const base = (function () {
    const s = document.currentScript;
    if (s && s.src) return s.src.substring(0, s.src.lastIndexOf('/') + 1);
    return './assets/js/';
  })();
  const cssHref = base + '../css/b-cookie-consent.css';
  const jsHref  = base + 'b-cookie-consent.js';
