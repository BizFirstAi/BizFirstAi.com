/**
 * Shared Layout Injector — Octopus by BizFirstAi
 * Dynamically injects header and footer into all Octopus pages.
 */
...
<nav class="b-navbar">
  <div class="b-navbar-container">
    ...
    <a href="https://bizfirstai.com" class="b-navbar-logo" target="_blank" rel="noopener">
      <img src="https://bizfirstai.com/website/assets/Logo/logo.png" alt="Octopus by BizFirstAi" class="b-logo-image">
    </a>
    ...
    <ul class="b-navbar-menu">
      ...
      <li><a href="https://community.bizfirstai.com/tag/octopus" class="b-nav-link" target="_blank" rel="noopener">Community</a></li>
...
<div class="b-mobile-menu" id="b-mobile-menu" aria-hidden="true">
  <div class="b-mobile-menu__header">
    <a href="https://bizfirstai.com" target="_blank" rel="noopener">
      <img src="https://bizfirstai.com/website/assets/Logo/logo.png" alt="Octopus by BizFirstAi" style="height:32px;width:auto;">
    </a>
  ...
  <nav class="b-mobile-nav">
    ...
    <a href="https://community.bizfirstai.com/tag/octopus" class="b-mobile-nav__link" target="_blank" rel="noopener">Community</a>
...
<div class="b-footer-container">
  ...
  <div class="b-footer-section">
    <div class="b-footer-brand">
      <img src="https://bizfirstai.com/website/assets/Logo/logo.png" alt="Octopus by BizFirstAi" style="height: 32px; width: auto; margin-bottom: 1rem;">
      <p class="b-footer-tagline">Multi-agent AI orchestration for the enterprise.</p>
    </div>
  </div>
  ...
  <div class="b-footer-section">
    ...
    <ul>
      ...
      <li><a href="https://community.bizfirstai.com/tag/octopus" target="_blank" rel="noopener">Community</a></li>
    </ul>
  </div>
